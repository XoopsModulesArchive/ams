...
// added 3.2 geekwright
define('_AMS_MI_HOME', 'Home');

define('_AMS_MI_SORT_COLUMN', 'Sort By');
define('_AMS_MI_SORT_COLUMN_DESC', 'Sort index list by this column');
define('_AMS_MI_SORT_COLUMN_PUBLISHED', 'Published Time');
define('_AMS_MI_SORT_COLUMN_TITLE', 'Article Title');
define('_AMS_MI_SORT_ORDER', 'Order');
