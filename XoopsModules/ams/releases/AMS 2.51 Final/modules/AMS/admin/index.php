...
function topicsmanager()
{
    ...
    if($topic_id > 0) {		// Edit mode
    	...
    	$groups_AMS_can_approve_checkbox = new XoopsFormCheckBox(_AMS_AM_APPROVEFORM, 'groups_AMS_can_approve[]');
    }
    ...
    if($topic_id > 0) {		// Edit mode
    	...
    	$groups_AMS_can_submit_checkbox = new XoopsFormCheckBox(_AMS_AM_SUBMITFORM, 'groups_AMS_can_submit[]');
    }
