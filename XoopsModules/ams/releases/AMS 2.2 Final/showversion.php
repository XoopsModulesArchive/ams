...
$xoopsTpl->assign('story', $article->toArray(true, true, $storypage, false, true));
...
$xoopsTpl->assign('xoops_pagetitle', $myts->makeTboxData4Show($article->title())." v.".$article->version());
