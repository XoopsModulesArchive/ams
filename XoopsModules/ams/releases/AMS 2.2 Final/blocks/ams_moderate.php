...
function b_ams_topics_moderate() {
    ...
    if ( count( $storyarray ) > 0 )
    {
        ...
        foreach( $storyarray as $newstory )
        {
            ...
            {
                $linktitle = "<a href='" . XOOPS_URL . "/modules/AMS/index.php?op=edit&amp;storyid=" . $newstory -> storyid() . "' target='_blank'>" . _AD_NOSUBJECT . "</a>";
            }
            else
            {
                $linktitle = "<a href='" . XOOPS_URL . "/modules/AMS/submit.php?op=edit&amp;storyid=" . $newstory -> storyid() . "' target='_blank'>" . $title . "</a>";
            }
            ...
            $story['action'] = "<a href='" . XOOPS_URL . "/modules/AMS/index.php?op=delete&amp;storyid=" . $newstory -> storyid() . "'>" . _AMS_MB_DELETE . "</a>";
