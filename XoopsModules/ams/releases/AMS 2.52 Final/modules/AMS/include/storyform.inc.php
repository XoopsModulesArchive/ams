...
//Added AMS 2.50. Enable user selection Editor
if($xoopsModuleConfig['editor_userchoice']==TRUE && (file_exists(XOOPS_ROOT_PATH."/Frameworks/xoops22/class/xoopsformloader.php")) )
{  print "ok";
