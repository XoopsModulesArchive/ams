	...
	if ($result) {
	    ...
	    if(isset($_POST['xoops_upload_file'])&& isset($_FILES[$_POST['xoops_upload_file'][0]]))
	    {
	        ...
	        if(trim($fldname!=''))
	        {
	            ...
	            $permittedtypes=array('text/xml','text/html', 'text/plain','image/tiff', 'image/vnd.microsoft.icon', 'image/gif', 'image/jpeg', 'image/pjpeg', 'image/x-png', 'image/png' ,'application/x-zip-compressed','application/msword', 'application/vnd.ms-excel', 'application/pdf', 'application/x-gtar', 'application/x-tar','application/zip');
