...
if ($xoopsModuleConfig['editor'] == "koivi" && $url !=""){
	...
	{
		$wysiwyg_text_area= new XoopsFormWysiwygTextArea( _AMS_NW_THESCOOP,'hometext', $myts->stripSlashesGPC($story->hometext),'100%', '200px', '');
		$wysiwyg_text_area2= new XoopsFormWysiwygTextArea( _AMS_AM_EXTEXT, 'bodytext', $myts->stripSlashesGPC($story->bodytext),'100%', '200px', '');
	}else
	{
		$wysiwyg_text_area= new XoopsFormWysiwygTextArea( array('caption'=>_AMS_NW_THESCOOP, 'name'=>'hometext', 'value'=>$myts->stripSlashesGPC($story->hometext), 'width'=>'100%', 'height'=>'200px'), '');
		$wysiwyg_text_area2= new XoopsFormWysiwygTextArea( array('caption'=>_AMS_AM_EXTEXT, 'name'=>'bodytext', 'value'=>$myts->stripSlashesGPC($story->bodytext), 'width'=>'100%', 'height'=>'200px'), '');
	}
