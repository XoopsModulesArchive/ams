#
# Table structure for table `ams_setting`
#
		
CREATE TABLE  `ams_setting` (
`settingid` int (11) unsigned NOT NULL  auto_increment,
`settingvalue` varchar (100)   NOT NULL  default '' ,
`settingtype` varchar (30) NOT NULL  default '' ,
`settingenable` tinyint (1) NOT NULL  default '0' ,
PRIMARY KEY (`settingid`)
) ENGINE=MyISAM;

#
# Table data for table `ams_setting`
#
...
`story_type` varchar (5)   NOT NULL  default '0',
...
`link_module` int (12)   NOT NULL  default '0',
...
#
# Table structure for table `ams_spotlight`
#
